class CanalXYZ{
  ...
  CanalXYZ(color nCor_,int x_, int y_, int w_, int h_){
     ...
     curveSuave=new CheckBox("curve suave",fm.x,fm.y+fm.h+5,15);
     verCanais=new CheckBox("ver canais",curveSuave.x,curveSuave.y+curveSuave.h+2,15);
